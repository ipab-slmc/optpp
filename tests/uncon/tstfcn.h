...
void rosen0_least_squares(int n, const NEWMAT::ColumnVector& x, NEWMAT::ColumnVector& fx, 
	int& result);
...
void rosen_least_squares(int mode, int n, const NEWMAT::ColumnVector& x, 
	NEWMAT::ColumnVector& fx, NEWMAT::Matrix& gx, int& result);
